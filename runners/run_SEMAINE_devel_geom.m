...
out_loc = './out_SEMAINE_dynamic_geom/';
...
parfor f1=1:numel(devel_recs)
    ...
    if(isdir([SEMAINE_dir, devel_recs{f1}]))
        ...
        for v=1:numel(vid_files)
            ...
            command = [features_exe, ' -auloc "./AU_predictors/AU_SVM_SEMAINE_dyn_geom.txt" -fx 800 -fy 800 -rigid -asvid -simscale 0.7 -simsize 112 '];
