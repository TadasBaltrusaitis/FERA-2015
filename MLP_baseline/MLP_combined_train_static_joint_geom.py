...
for i in range(3):
    ...
    _, _, _, _, f1, _, _ = test_fn(valid_labels_bp4d[:, inds_to_use_bp4d], valid_samples_bp4d, model)
...
f = open("./trained/BP4D_train_mlp_combined_geom.txt", 'w')
...
f = open("./trained/BP4D_train_mlp_combined_disfa_geom.txt", 'w')
f.write(str(best_params)+'\n')
