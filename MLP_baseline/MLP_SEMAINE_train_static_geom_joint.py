...
(all_aus, train_recs, devel_recs, BP4D_dir, hog_data_dir) = shared_defs_SEMAINE.shared_defs()
...
[train_samples, train_labels, valid_samples, valid_labels, raw_valid, PC, means, scaling] = \
    data_preparation.Prepare_HOG_AU_data_generic_SEMAINE(train_recs, devel_recs, all_aus, BP4D_dir, hog_data_dir, pca_loc, geometry=True)
...
f = open("./trained/SEMAINE_train_mlp_geom_static_joint.txt", 'w')
