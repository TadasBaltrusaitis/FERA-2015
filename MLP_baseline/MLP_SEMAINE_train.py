...
from shared_defs_SEMAINE import *
...
for au in all_aus:
    ...
    [train_samples, train_labels, valid_samples, valid_labels, raw_valid, PC, means, scaling] = data_preparation.Prepare_HOG_AU_data_generic_BP4D(train_recs, devel_recs, au, SEMAINE_dir, hog_data_dir, pca_loc);
