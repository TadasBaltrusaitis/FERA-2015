...
%% DISFA
hog_dir = 'D:\datasets\face_datasets\DISFA\hog_aligned_rigid/';
hog_files = dir([hog_dir, '*.hog']);
...
%% BP4D
hog_dir = 'D:\datasets\face_datasets\fera_2015\bp4d\processed_data/train/';
hog_files = dir([hog_dir, '*.hog']);
...
%% SEMAINE
hog_dir = 'D:\datasets\face_datasets\fera_2015\semaine\processed_data\train\';
hog_files = dir([hog_dir, '*.hog']);
