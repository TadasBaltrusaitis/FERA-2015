function Script_HOG_SVM_train_joint_static_train_DISFA()
...
%     assert(norm(preds_mine - actual_vals) < 1e-8);
    ...
    name = sprintf('camera_ready/AU_%d_static_combined_disfa.dat', au);
    ...
    name = sprintf('camera_ready/AU_%d_static_combined_disfa.mat', au);
