function Script_HOG_SVM_train_joint_dynamic_train_SEMAINE()
...
%     assert(norm(preds_mine - actual_vals) < 1e-8);
    ...
    name = sprintf('camera_ready/AU_%d_dynamic_combined_semaine.dat', au);
    ...
    name = sprintf('camera_ready/AU_%d_dynamic_combined_semaine.mat', au);
