function Script_HOG_SVM_train_joint_dynamic_train_BP4D()
...
%     assert(norm(preds_mine - actual_vals) < 1e-8);
    ...
    name = sprintf('camera_ready/AU_%d_dynamic_combined_bp4d.dat', au);
    ...
    name = sprintf('camera_ready/AU_%d_dynamic_combined_bp4d.mat', au);
