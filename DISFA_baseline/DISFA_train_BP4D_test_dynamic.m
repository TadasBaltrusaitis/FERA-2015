...
raw_devel_geom = Read_geom_files_dynamic(devel_recs, [hog_data_dir, '/devel/']);
...
for i=1:numel(aus_to_test)   
    ...
    model_file = sprintf('../DISFA_baseline/training/paper_res/AU_%d_dynamic.mat', aus_to_test(i));
    load(model_file);
