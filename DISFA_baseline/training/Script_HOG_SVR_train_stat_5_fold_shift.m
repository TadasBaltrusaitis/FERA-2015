function Script_HOG_SVR_train_stat_5_fold_shift()
...
for a=1:numel(aus)
    ...
    for t=1:num_test_folds
        ...
        [~, ~, test_samples, test_labels, ~, ~, ~, ~, test_ids] = Prepare_HOG_AU_data_generic(users, au, rest_aus, hog_data_dir, t, 1/num_test_folds);
...
%         svs = bsxfun(@times, PC, 1./scaling') * w;
    ...
    [ accuracies, F1s, corrs, rms, classes ] = evaluate_classification_results( prediction_all, test_all );    
