function Script_HOG_SVR_train_dyn_out_au1()
...
for a=1:numel(aus)
    ...
    [train_samples, train_labels, valid_samples, valid_labels, raw_valid, PC, means, scaling] = Prepare_HOG_AU_data_generic_dynamic_more_train(users(train_users), au, rest_aus, hog_data_dir);
    ...
    name = sprintf('train_11_05_more_train/AU_%d_dyn.dat', au);

    write_lin_dyn_svr(name, means, svs, b);

    name = sprintf('train_11_05_more_train/AU_%d_dyn.mat', au);
