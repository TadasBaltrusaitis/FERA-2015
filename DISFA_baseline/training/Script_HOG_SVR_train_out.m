function Script_HOG_SVR_train_out()
...
for a=1:numel(aus)
    ...
    au = aus(a);
        ...
        name = sprintf('trained_static/AU_%d_static.dat', au);
        
        write_lin_svr(name, means, svs, b);
        
        name = sprintf('trained_static/AU_%d_static.mat', au);
...
%         name = sprintf('results_generic/Res_HOG_SVR_lin_%d', au);
