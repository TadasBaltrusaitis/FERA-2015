function [data_train, labels_train, data_valid, labels_valid, raw_valid, PC, means_norm, stds_norm] = ...
    Prepare_HOG_AU_data_generic_dynamic_with_ck(train_users, au_train, rest_aus, hog_data_dir, ck_data_dir)
...
ck_hog_data = Read_HOG_files_CK_dynamic(vid_inds, 'C:\tadas\face_datasets\hog_aligned_rigid/');
