function Script_HOG_SVR_train_disfa()
...
for a=1:numel(all_aus_int)
    ...
    [~, ~, vid_ids_train, valid_samples, valid_labels, vid_ids_valid, raw_valid, PC, means, scaling] = Prepare_HOG_AU_data_generic_intensity(train_recs, devel_recs, au, BP4D_dir_int, hog_data_dir, pca_loc);
