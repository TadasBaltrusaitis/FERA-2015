function Script_HOG_SVM_train_dyn_bp4d_PCA()
...
pca_loc = '../pca_generation/bp4d_model.mat';
...
for a=1:numel(aus)
    ...
    [train_samples, train_labels, valid_samples, valid_labels, ~, PC, means, scaling] = Prepare_HOG_AU_data_generic_dynamic(train_recs, devel_recs, au, BP4D_dir, hog_data_dir, pca_loc);
