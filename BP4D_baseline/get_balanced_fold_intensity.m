function [train_users, dev_users] = get_balanced_fold_intensity(BP4D_dir, users, au, prop_test)

    % Extracting the labels
    [labels, valid_ids, vid_ids, filenames] = extract_BP4D_labels_intensity(BP4D_dir, users, au);
