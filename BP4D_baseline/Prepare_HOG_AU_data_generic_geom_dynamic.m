function [data_train, labels_train, data_devel, labels_devel, raw_devel, PC, means_norm, stds_norm] = ...
    Prepare_HOG_AU_data_generic_geom_dynamic(train_users, devel_users, au_train, bp4d_dir, hog_data_dir, pca_file)
...
[train_geom_data, valid_ids_train_geom] = Read_geom_files_dynamic(train_users, [hog_data_dir, '/train/']);
...
[devel_geom_data, valid_ids_devel_geom] = Read_geom_files_dynamic(devel_users, [hog_data_dir, '/devel/']);
