...
for a=1:numel(aus)
    ...
    if(ismember(aus(a), semaine_au) || ismember(aus(a), disfa_au))
        ...
        [train_samples, train_labels, test_samples, test_labels, raw_valid, PC, means, scaling] = Prepare_HOG_AU_data_generic(train_recs, devel_recs, au, BP4D_dir, hog_data_dir, pca_loc);
        ...
        name = sprintf('paper_res/AU_%d_static_combined_v_bp4d.dat', au);
