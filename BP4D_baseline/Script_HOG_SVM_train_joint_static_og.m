function Script_HOG_SVM_train_joint_static_og()
...
for a=1:numel(aus)
    ...
    if(ismember(aus(a), semaine_au) || ismember(aus(a), disfa_au))
        ...
        raw_valid = extract_og(raw_valid);
        if(ismember(aus(a), semaine_au))
            ...
            train_samples_sem = extract_og(train_samples_sem);
        ...
        if(ismember(aus(a), disfa_au))
            ...
            train_samples_disfa = extract_og(train_samples_disfa);
