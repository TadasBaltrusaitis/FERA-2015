...
raw_geom = Read_geom_files_dynamic(devel_recs, [hog_data_dir, '/devel/']);
...
for i=1:numel(aus_to_test)   
    ...
    model_file = sprintf('../SEMAINE_baseline/paper_res/AU_%d_dynamic.mat', aus_to_test(i));
    load(model_file);
...
for i=1:numel(aus_to_test)
   ...
   name = sprintf('trained/AU_%d_semaine_stat.mat', aus_to_test(i));
