function [data_train, labels_train, data_devel, labels_devel, raw_devel, PC, means_norm, stds_norm] = ...
    Prepare_HOG_AU_data_generic_dynamic_clever(train_users, devel_users, au_train, rest_aus, semaine_dir, hog_data_dir, pca_file)
...
% Subsample the data to make training quicker and better
...
num_other = floor(pos_count / (size(labels_other, 2) + 1));
