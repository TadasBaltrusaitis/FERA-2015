function [data_train, labels_train, data_devel, labels_devel, raw_devel, PC, means_norm, stds_norm] = ...
    Prepare_HOG_AU_data_generic_geom(train_users, devel_users, au_train, rest_aus, semaine_dir, hog_data_dir, pca_file)
...
[train_geom_data, valid_ids_train_geom] = Read_geom_files(train_users, vid_ids_train, [hog_data_dir, '/train/']);
...
[devel_geom_data, valid_ids_devel_geom] = Read_geom_files(devel_users, vid_ids_devel, [hog_data_dir, '/devel/']);
