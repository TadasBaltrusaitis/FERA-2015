function Script_HOG_SVM_train_geom()
...
for a=1:numel(aus)
    ...
    [train_samples, train_labels, valid_samples, valid_labels, raw_valid, PC, means, scaling] = Prepare_HOG_AU_data_generic_geom(train_recs, devel_recs, au, rest_aus, SEMAINE_dir, hog_data_dir, pca_loc);
...
%     name = sprintf('geom_res/AU_%d_dynamic.dat', au);
%         
...
%     write_lin_dyn_svm(name, means, svs, b, pos_lbl, neg_lbl);
    ...
    name = sprintf('geom_res/AU_%d_static_loc_params_no_m.mat', au);
