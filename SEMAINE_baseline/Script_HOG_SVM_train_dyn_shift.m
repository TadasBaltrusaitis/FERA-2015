function Script_HOG_SVM_train_dyn_shift()
...
for a=1:numel(aus)
    ...
    [~, ~, test_samples, test_labels, raw_test, ~,~,~, test_ids] = Prepare_HOG_AU_data_generic_dynamic(train_recs, test_recs, au, rest_aus, SEMAINE_dir, hog_data_dir, pca_loc);
    
    [train_samples, train_labels, valid_samples, valid_labels, ~, PC, means, scaling, valid_ids] = Prepare_HOG_AU_data_generic_dynamic(train_recs, valid_recs, au, rest_aus, SEMAINE_dir, hog_data_dir, pca_loc);
