function Script_HOG_SVM_train_joint_dynamic_v_sem()
...
for a=1:numel(aus)
    ...
    if(ismember(aus(a), bp4d_au) || ismember(aus(a), disfa_au))
        ...
        if(ismember(aus(a), disfa_au))
            ...
            load(sprintf('paper_res/AU_%d_train_DISFA_test_SEMAINE.mat', aus(a)), 'best_params');
        ...
        name = sprintf('camera_ready/AU_%d_dynamic_combined_v_sem.dat', au);
        ...
        name = sprintf('camera_ready/AU_%d_dynamic_combined_v_sem.mat', au);
