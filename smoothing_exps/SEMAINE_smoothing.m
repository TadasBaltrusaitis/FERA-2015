...
[~, ~, valid_samples_bp4d, valid_labels_bp4d, raw_valid, PC, means, scaling] = Prepare_HOG_AU_data_generic_dynamic(train_recs, devel_recs, all_aus, BP4D_dir, hog_data_dir, pca_loc);
cd(od);
%%
i = 1;
for a=all_aus
    ...
    load(sprintf('../SEMAINE_baseline/camera_ready/AU_%d_dynamic.mat', a));
