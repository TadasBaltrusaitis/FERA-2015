...
for a=1:numel(aus)
    ...
    for t = 1:num_test_folds
        ...
        [~, ~, valid_samples_disfa, valid_labels_disfa, ~, PC, means, scaling, valid_ids, valid_success] = Prepare_HOG_AU_data_generic_dynamic({}, train_users, au, rest_aus, hog_data_dir);
        cd(od);
