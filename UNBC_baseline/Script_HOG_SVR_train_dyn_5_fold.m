...
for a=1:numel(aus)
    ...
    for t=1:num_test_folds
        ...
        [~, ~, test_samples, test_labels, ~, ~, ~, ~, test_ids, test_success] = Prepare_HOG_AU_data_dynamic({}, test_folds{t}, au, rest_aus, UNBC_dir, hog_data_dir, '../pca_generation/generic_face_rigid.mat');
