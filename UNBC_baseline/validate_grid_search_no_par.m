function [ best_params, all_params ] = validate_grid_search_no_par(train_fn, test_fn, minimise, samples_train, labels_train, samples_valid, labels_valid, hyperparams, varargin)
