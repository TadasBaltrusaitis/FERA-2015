...
hog_data_dir_SEMAINE = hog_data_dir;
...
for a=1:numel(aus)
    ...
    [train_samples, train_labels, valid_samples, valid_labels, ~, PC, means, scaling] = Prepare_HOG_AU_data_generic_dynamic(train_recs, valid_SEMAINE_recs, au, rest_aus, SEMAINE_dir, hog_data_dir_SEMAINE, pca_loc);
    ...
    for t = 1:num_test_folds
        ...
        [valid_samples_disfa, valid_labels_disfa, test_samples_disfa, test_labels_disfa] = Prepare_HOG_AU_data_generic_dynamic(train_users, test_users, au, rest_aus, hog_data_dir);
        cd(od);
