...
for a=1:numel(aus)
    ...
    [train_samples, train_labels, valid_samples, valid_labels, ~, PC, means, scaling] = Prepare_HOG_AU_data_generic(train_recs, valid_SEMAINE_recs, au, rest_aus, SEMAINE_dir, hog_data_dir_SEMAINE, pca_loc);
